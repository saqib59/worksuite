                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <x-forms.datepicker fieldId="start_date" fieldRequired="true"
                            ...
                            :fieldValue="(!is_null($contract->end_date) ? $contract->end_date->timezone($global->timezone)->format($global->date_format) : $contract->start_date->timezone($global->timezone)->format($global->date_format))"
