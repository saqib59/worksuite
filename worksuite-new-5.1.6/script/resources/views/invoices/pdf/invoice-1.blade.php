...
<body>
    <header class="clearfix">
        ...
        <table cellpadding="0" cellspacing="0" class="billing">
            <tr>
                <td colspan="2"><h1>@lang('app.invoice')</h1></td>
            </tr>
            <tr>
                <td id="invoiced_to">
                    <div>
                        ...
                        @elseif(($invoice->client && $invoice->clientDetails)
                            ...
                            @endif
                        @elseif((is_null($invoice->project) && $invoice->estimate && $invoice->estimate->client && $invoice->estimate->client->clientDetails)
                            && ($invoiceSetting->show_client_name == 'yes' || $invoiceSetting->show_client_email == 'yes' || $invoiceSetting->show_client_phone == 'yes' || $invoiceSetting->show_client_company_name == 'yes' || $invoiceSetting->show_client_company_address == 'yes'))
        ...
        <table cellspacing="0" cellpadding="0" id="invoice-table">
            ...
            <tfoot>
                ...
                <tr dontbreak="true">
                    ...
                    <td style="text-align: center">{{ currency_formatter($invoice->amountDue(),'') }} {{ $invoice->currency->currency_code }}</td>
                </tr>
            </tfoot>
        </table>
