                                ...
                                <div class="form-group">
                                    ...
                                    @elseif($field->type == 'date')
                                        <x-forms.datepicker custom="true"
                                            ...
                                            :fieldLabel="$field->label"
                                            fieldName="custom_fields_data[{{ $field->name . '_' . $field->id }}]"
                                            :fieldValue="($product->custom_fields_data['field_'.$field->id] != '') ? \Carbon\Carbon::parse($product->custom_fields_data['field_'.$field->id])->format($global->date_format) : \Carbon\Carbon::now()->format($global->date_format)"
                                            :fieldPlaceholder="$field->label" />
        ...
        $('#save-product-form').click(function() {
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    ...
                    console.log(productDropzone.getQueuedFiles().length);
