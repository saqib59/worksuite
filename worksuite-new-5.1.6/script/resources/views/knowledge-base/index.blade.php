        ...
        <div class="settings-sidebar bg-white py-3" id="mob-settings-sidebar">
            ...
            <ul class="settings-menu" id="settingsMenu">
                ...
                @foreach ($categories as $item)
                    <x-setting-menu-item :active="$activeMenu" :menu="strtolower(str_replace(' ', '_', $item->name))"
                ...
                <form action="" id="filter-form">
                    <div class="row mb-2">
                        @if ($addknowledgebasePermission == 'all')
                            <div class="col-md-3">
                                <x-forms.link-primary :link="route('knowledgebase.create')"
                                    class="mb-2 openRightModal float-left" icon="plus">
                        ...
                        <div class="col-md-3">
                            <div class="input-group bg-grey rounded border">
                                ...
                                <input type="text" class="form-control height-35 f-14 p-1 border-additional-grey" id="search-text-field" placeholder="@lang('app.startTyping')">
                            </div>
                        </div>
