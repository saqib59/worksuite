            ...
            ->editColumn('board_column', function ($row) use ($taskBoardColumns) {
                ...
                if (
                    ...
                    foreach ($taskBoardColumns as $item) {
                        ...
                        $status .= '  data-content="<i class=\'fa fa-circle mr-2\' style=\'color: ' . $item->label_color . '\'></i> ' . ($item->slug == 'completed' || $item->slug == 'incomplete' ? __('app.' . $item->slug) : $item->column_name) . '" value="' . $item->slug . '">' . ($item->slug == 'completed' || $item->slug == 'incomplete' ? __('app.' . $item->slug) : $item->column_name) . '</option>';
                    }
