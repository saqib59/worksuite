...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        'App\Events\InvoiceUpdatedEvent' => ['App\Listeners\InvoiceUpdatedListener'],
        ...
        'App\Events\NewOrderEvent' => ['App\Listeners\NewOrderListener'],
        'App\Events\OrderUpdatedEvent' => ['App\Listeners\OrderUpdatedListener'],
        'App\Events\NewUserRegistrationViaInviteEvent' => ['App\Listeners\NewUserRegistrationViaInviteListener'],
        'App\Events\AutoFollowUpReminderEvent' => ['App\Listeners\AutoFollowUpReminderListener'],
    ];
